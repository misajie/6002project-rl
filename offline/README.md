...
+ Coding reference, simple but useful by Fujimoto: 
	+ [TD3-BC](https://github.com/sfujim/TD3/blob/master/TD3.py)
	+ [BCQ, Fujimoto, 2019](https://github.com/sfujim/BCQ)
## Dataset benchmarks (can be found in CQL repository)
+ [d4rl](https://github.com/rail-berkeley/d4rl)
+ [Atari 2600](https://github.com/google-research/batch_rl)